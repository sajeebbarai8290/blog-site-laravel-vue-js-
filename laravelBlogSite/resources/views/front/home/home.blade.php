  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card h-100">
              <img class="card-img-top" src="{{asset($blog->blog_image)}}" alt="{{$blog->blog_title}}" height="250px"/>
              <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="{{asset($popularBlog->blog_image)}}" alt="{{$popularBlog->blog_title}}" height="250px"></a>
            <div class="card-body">
