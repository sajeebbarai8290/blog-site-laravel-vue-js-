...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card my-4">
                <div class="card-body">
                    <h5 class="card-title">you have to login to comment this blog.If you are register then <a href="{{route('visitor-login')}}">login</a> or <a href="{{route('new-signUp')}}">sign up</a></h5>
                </div>
            </div>
            @endif
